...
namespace BlueChecker
{
    class Encryption { 
        ...
        /// </remarks>
        private static string SimpleEncrypt(string secretMessage, byte[] cryptKey, byte[] authKey,
        ...
        private static string SimpleDecrypt(string encryptedMessage, byte[] cryptKey, byte[] authKey,
