    ...
    class WebAutomationToolkit
    {
        ...
        public class Utilities
        {
            ...
            public static void Wait(int WaitTimeInSeconds)
            {
                ...
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Utilities.Wait().");
        ...
        public class Forms
        {
            ...
            public static void MsgBox(string StringToDisplay)
            {
                ...
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Forms.MsgBox().");
                    System.Console.WriteLine(ex.ToString());
                    return;
                }
            }
            ...
            public static void fillFormByID(string[,] elementIDsAndInputs)
            {
                ...
                try
                {
                    for (int row = 0; row < elementIDsAndInputs.GetLength(0); row++)
                    {
                        ...
                        WebAutomationToolkit.Web.Edit.SetTextByID(elementID, elementInput);
                    }
                }
                catch (Exception ex)
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Forms.fillFormByID().");
                    System.Console.WriteLine(ex.ToString());
                    return;
                }
            }
        ...
        public class Web
        {
            ...
            public static void scrollUpwards()
            {
                ...
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.scrollUpwards().");
                    System.Console.WriteLine(ex.ToString());
                    return;
                }
            }
            ...
            public static void scrollDownwards()
            {
                ...
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.scrollDownwards().");
                    System.Console.WriteLine(ex.ToString());
                    return;
                }
            }
            ...
            public static void NavigateToURL(string URL)
            {
                ...
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.NavigateToURL().");
                    System.Console.WriteLine(ex.ToString());
                    return;
                }
            }
            ...
            public static void NavigateForward()
            {
                ...
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.NavigateForward().");
                    System.Console.WriteLine(ex.ToString());
                    return;
                }
            }
            ...
            public static void NavigateBackward()
            {
                ...
                {
                    System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.NavigateBackward().");
                    System.Console.WriteLine(ex.ToString());
                    return;
                }
            }
            ...
            public class Edit
            {
                ...
                public static void SetTextByID(string ObjectID, string TextToSet)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Edit.SetTextByID().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void SetTextToMultiByID(string ObjectID, string TextToSet)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Edit.SetTextToMultiByID().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void SetTextByCSSPath(string CSSPath, string TextToSet)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Edit.SetTextTByCSSPath().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
            ...
            public class Button
            {
                ...
                public static void ClickByXPath(string XPath)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Button.ClickByXPath().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void ClickByName(string Name)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Button.ClickByName().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void ClickByID(string ObjectID)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Button.ClickByID().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void ClickByCSSPath(string CSSPath)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Button.ClickByCSSPath().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void ClickByLinkText(string linkText)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Button.ClickByLinkText().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void ClickByTagName(string tagName)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Button.ClickByTagName().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
                ...
                public static void ClickByClassName(string className)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Button.ClickByClassName().");
                        System.Console.WriteLine(ex.ToString());
                        return;
                    }
                }
            ...
            public class Link
            {
                ...
                public static void ClickByXPath(string XPath)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Link.ClickByXPath().");
                        System.Console.WriteLine(ex.ToString());
                ...
                public static void ClickByText(string Text)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Link.ClickByText().");
                        System.Console.WriteLine(ex.ToString());
                ...
                public static void ClickByID(string ObjectID)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Link.ClickByID().");
                        System.Console.WriteLine(ex.ToString());
                ...
                public static void ClickIfExistByXPath(string XPath)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Link.ClickIfExistsByXPath().");
                        System.Console.WriteLine(ex.ToString());
                ...
                public static void ClickIfExistByName(string Name)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Link.ClickIfExistsByName().");
                        System.Console.WriteLine(ex.ToString());
                ...
                public static void ClickIfExistByID(string ObjectID)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Link.ClickIfExistsByID().");
                        System.Console.WriteLine(ex.ToString());
            ...
            public class Table
            {
                ...
                public static string FindRecordWithRowColByCSSPath(string CSSPath, int row, int col)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Table.FindRecordWithRowColByCSSPath().");
                        System.Console.WriteLine(ex.ToString());
            ...
            public class Element
            {
                ...
                public static bool ExistsByCSSPath(string CSSPath)
                {
                    ...
                    {
                        System.Console.WriteLine("Unspecified exception in WebAutomationToolkit.Web.Element.ExistsByCSSPath().");
                        System.Console.WriteLine(ex.ToString());
